...
def plot_loss_acc(metric_dict, figsize=(5, 15)):
    ...
    curr_ax.legend(['train_loss', 'validation_loss'])
...
def test_relu(in_shape, Layer):
    # Step1: Make matrix in the shape of (in_shape)
    # Each element can contain any number between -50 and 50
...
def apply_mask_rcnn(im_path, model, topk, device, figsize=(20, 20)):
    ...
    assert os.path.exists(
        im_path), "Cannot find your image (%s); make sure it is in your directory." % (im_path)
